...
To enable ES6 support rename the `es6Scripts` Gulp task to `scripts` in the [Gulp file](gulpfile.babel.js).
ES6 source code will be automatically trancompiled to ES3 for wide browser support.
